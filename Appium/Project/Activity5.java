...
public class Activity5 {
	...
	public void loginPageTest() {
		...
		//Point start = new Point((int) (dims.getWidth() * 0.7), (int) (dims.getHeight() * 0.86));
		//Point end = new Point((int) (dims.getWidth() * 0.7), (int) (dims.getHeight() * 0.9));
		//
		Point start = new Point((int) (dims.getWidth() * 0.6), (int) (dims.getHeight() * 0.76));
		Point end = new Point((int) (dims.getWidth() * 0.6), (int) (dims.getHeight() * 0.4));
	...
	public void invalidLoginTest() throws InterruptedException {
		...
		// Find the input fields username and password and click on login
		...
		// Wait for message 'Invalid credentials' and get text
